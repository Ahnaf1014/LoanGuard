...
- Eight triggers validate loan/application state, reject overpayments, and keep
  balances synchronized when paid payments are inserted, updated, or deleted.
